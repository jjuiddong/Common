...
cQuad2D2::cQuad2D2()
	: cNode(common::GenerateId(), "Quad2d2", eNodeType::MODEL)
	, m_texture(NULL)
...
// width, height : 쿼드 크기
// pos : 쿼드 위치
bool cQuad2D2::Create(cRenderer &renderer, const float x, const float y
...
bool cQuad2D2::Render(cRenderer &renderer
...
void cQuad2D2::SetPosition(const float x, const float y
	, const float width, const float height
)
{
...
cNode* cQuad2D2::Picking(const Ray &ray, const eNodeType::Enum type
