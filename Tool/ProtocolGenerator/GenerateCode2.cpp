...
namespace compiler2
{
	...
	map<string, string> g_typeMapTable = {
		{"BYTE", "Map<string, number>"},
		{"char", "Map<string, number>"},
		{"bool", "Map<string, boolean>"},
		{"BOOL", "Map<string, boolean>"},
		{"short", "Map<string, number>"},
		{"ushort", "Map<string, number>"},
		{"unsigned short", "Map<string, number>"},
		{"int", "Map<string, number>"},
		{"uint", "Map<string, number>"},
		{"unsigned int", "Map<string, number>"},
		{"int64", "Map<string, bigint>"},
		{"uint64", "Map<string, bigint>"},
		{"__int64", "Map<string, bigint>"},
		{"unsigned __int64", "Map<string, bigint>"},
