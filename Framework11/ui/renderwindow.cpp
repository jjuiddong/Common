...
)
{
	...
	if (!mainWindow)
	{
		...
		StrPath path1 = cResourceManager::Get()->GetMediaDirectory() + "extra_fonts/나눔고딕Bold.ttf";
		...
		//io.Fonts->AddFontFromFileTTF("../Media/extra_fonts/나눔고딕Bold.ttf", fontSize, NULL, io.Fonts->GetGlyphRangesKorean());
		//m_fontBig = io.Fonts->AddFontFromFileTTF("../Media/extra_fonts/나눔고딕Bold.ttf", bigFontSize, NULL, io.Fonts->GetGlyphRangesKorean());
