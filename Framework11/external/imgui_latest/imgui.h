...
namespace ImGui
{
	...
	IMGUI_API void          PlotLines2(const char* label, const float* values, int values_count, int values_offset = 0, int text_value_offset=0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride = sizeof(float));
