...
namespace ImGui
{
	...
	IMGUI_API void          PlotEx2(ImGuiPlotType plot_type, const char* label, float(*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, int text_value_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size);
