...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonOption(const char* label, const ImVec2& size_arg = ImVec2(0, 0), const bool enable = true);
    ...
    IMGUI_API bool          BeginCombo2(const char* label, const char* preview_value, const float scale, const ImVec2 &offset, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API bool          DragDouble(const char* label, double* v, double v_speed = 1.0, double v_min = 0.0, double v_max = 0.0, const char* format = "%.3f", double power = 1.0);     // If v_min >= v_max we have no bound
