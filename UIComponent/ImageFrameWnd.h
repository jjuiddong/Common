...
public:
	...
	bool Init(const string &windowName, const string &fileName, const CRect &initialRect, 
		CWnd *parentWnd, const bool isAutoSize=false, const bool isTopmost=true);
	bool Init(const string &windowName, const cv::Mat &img, const CRect &initialRect, 
		CWnd *parentWnd, const bool isAutoSize = false, const bool isTopmost = true);
	bool ShowImage(const string &fileName);
	bool ShowImage(const cv::Mat &img);
...
protected:
	void Initialize(const string &windowName, const CRect &initialRect, 
