...
namespace tess
{
	...
	public:
		...
		string Dictionary(const string &src, OUT float &maxFitness, const int flags=0);
		string Dictionary2(const string &src, OUT string &out, OUT float &maxFitness, OUT int &t1, OUT int &t2); // debugging
